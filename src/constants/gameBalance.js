...
export const BAL = {
  ...
  stream: {
    baseFailRate: 0.35,
    skillFailReduce: 0.002,
    minFailRate: 0.05,
    successMin: 400,
    successMax: 1800,
    chat: { virtueGainMin: 3, virtueGainMax: 9 },
  ...
  dice: {
    ...
    /** TODO: テスト用 100% — 本番に戻すときは 0.4 などに再度変更 */
    taxiCongestChance: 1,
    taxiCongestPon: 10,
...
export const CHARACTERS = {
  ...
  student: {
    ...
    label: "ギャンブル初心者な大学生",
    emoji: "🎓",
    desc: "運+10・技量-30。ビギナーズラックでスロットがやや有利。生活費は低めだが仕事収入は半分、PON発火時の資金ペナルティは軽め。配信は通常どおり。",
  ...
  vtuber: {
    ...
    label: "リリム",
    emoji: "🎭",
    desc: "技量-20・運+10・生活費300Gでスタート。PON上昇1.2倍。失言がバズるたびに配信報酬倍率が+0.5される。",
